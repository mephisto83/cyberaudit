  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="relative overflow-hidden py-20 sm:py-32">
        <div className="absolute inset-0 bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950/30 dark:to-gray-900" />
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-6xl mb-6">
            <span className="text-red-600">CyberAudit</span><br/>AI Security Scanning
          </h1>
          <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-400 mb-10">Detect vulnerabilities and security risks in your AI systems with comprehensive auditing.</p>
          <div className="flex items-center justify-center gap-4">
            <a href="#/signup" className="rounded-lg bg-red-600 px-6 py-3 text-sm font-semibold text-white shadow-lg hover:bg-red-500">Get Started Free &rarr;</a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((f, i) => (
              <div key={i} className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                <div className="w-12 h-12 rounded-lg bg-red-100 dark:bg-red-900/30 flex items-center justify-center text-red-600 mb-4">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl bg-red-600 px-8 py-16 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Ready to get started?</h2>
            <p className="text-red-100 mb-8">Join teams using CyberAudit today.</p>
            <a href="#/signup" className="inline-block rounded-lg bg-white px-8 py-3 text-sm font-semibold text-red-600 hover:bg-gray-100">Start Free Trial</a>
          </div>
        </div>
      </section>
    </div>
