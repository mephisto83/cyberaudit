...
const LandingPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Generate detailed compliance reports for SOC2, GDPR, and AI-specific regulatory frameworks.',
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content: 'CyberAudit reduced our inference costs by 45% while maintaining quality. Game-changer.',
      avatar: '👩‍💼',
    },
    {
      name: 'Marcus Johnson',
